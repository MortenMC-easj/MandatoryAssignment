...
public class ConsumeWristbandData extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final ConsumeWristbandData.ReadJSONFeedTask task = new ConsumeWristbandData.ReadJSONFeedTask();
    ...
    private class ReadJSONFeedTask extends AsyncTask<String, Void, String> {
        ...
        protected void onPostExecute(String jsonString) {
            ...
            try {
                List<WristBandData> datas = new ArrayList<>();
                ...
                for (int i = 0; i < array.length(); i++) {
                    ...
                    WristBandData data = new WristBandData(deviceId, pm25, pm10, co2, o3, pressure, temperature, humidity);
                    datas.add(data);
                    //textView.setText(title + ": " + body + "\n");
                }
                ArrayAdapter<WristBandData> adapter =
                        new ArrayAdapter<WristBandData>(getBaseContext(), android.R.layout.simple_list_item_1, datas);
